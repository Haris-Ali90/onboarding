...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('basic-category.index') }}
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                      {{--  @if(HasPermissionAccess($userPermissoins['type'],'add',$userPermissoins['permissions']))
                        <a href="{!! URL::route('basic-category.create') !!}" id="sample_editable_1_new" class="btn blue">
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 80%" class="text-center">Category</th>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        $('#cancel').click(function() {
            window.location.href = "{!! URL::route('basic-category.index') !!}";
        });
    });
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('basic-category.data') }}');
