...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('quiz-management.show', $quizManagement) }}
                            ...
                            <div class="col-sm-12 show-details-box">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                     ...
                                     @foreach($quizManagement->questions as $key => $question )
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{!! URL::route('quiz-management.edit', $question->id) !!}" title="Edit"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    {!! Form::model($question, ['method' => 'delete',  'url' => 'admin/quiz-management/'.$question->id, 'class' =>'form-inline form-delete']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <button class="btn black" id="cancel"
                                        onclick="window.location.href = '{!! URL::route('quiz-management.index') !!}'">
                                    Back..
                                </button>
                            </div>
                        </div>
