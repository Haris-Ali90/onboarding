...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('order-category.edit', $orderCategory) }}
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('order-category.update', $orderCategory->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
