...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('order-category.index') }}
    ...
    <div class="row">
        ...
        <div class="row">
                <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                    @if(can_access_route('order-category.create',$userPermissoins))
                        <a href="{!! URL::route('order-category.create') !!}" style="background-color: #e36d29" title="create"
...
{{--    <script type="text/javascript" src="{!! URL::to('assets/admin/plugins/data-tables/DT_bootstrap.js') !!}"></script>--}}
    ...
    <script>
      ...
      $(function () {
          appConfig.set('yajrabox.ajax', '{{ route('order-category.data') }}');
