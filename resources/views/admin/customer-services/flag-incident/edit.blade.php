...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('flag-incident.edit', $flag_incident) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <form method="POST" action="{{ route('flag-incident.update',$flag_incident) }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="name" maxlength="150" value="{{ old('name', $incident_list->name) }}" class="form-control" required/>
                            </div>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="number" id="days_duration" name="days_duration" value="{{ old('days_duration', $incident_list->days_duration) }}" class="form-control" min="1" max="365" required />
                            </div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            $('#cancel').click(function () {
                window.location.href = "{!! URL::route('flag-incident.index') !!}";
            });
