...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('work-time.index') }}
...
<div class="row">
    <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                       {{-- @if(HasPermissionAccess($userPermissoins['type'],'add',$userPermissoins['permissions']))
                        <a href="{!! URL::route('work-time.create') !!}" id="sample_editable_1_new" class="btn blue">
        ...
        <div class="row">
            ...
            @if(can_access_route('work-time.create',$userPermissoins))
                <a href="{!! URL::route('work-time.create') !!}" style="background-color: #e36d29" title="create"
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 40%" class="text-center" >Start time</th>
                            <th style="width: 40%" class="text-center" > End time</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('work-time.data') }}');
        ...
        appConfig.set('yajrabox.columns', [
            ...
            {data: 'start_time',   orderable: true,   searchable: true, className:'text-center'},
            {data: 'end_time',         orderable: true,    searchable: true, className:'text-center'},
