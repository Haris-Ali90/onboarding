...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('training.create') }}
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('training.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
               {{--     <div  class="form-group" >
                        <label class="col-md-2 control-label">Type *</label>
                        <div class="col-md-4">
                        <label ><input type="radio" class="cat_type" name="type" value="orderCategoryDD"  />By Order Category</label>

                        <label  ><input type="radio" class="cat_type" name="type" value="vendorDD"  />By Vendor</label>
                        </div>
                        @if ($errors->has('type'))
              ...
              {{--      <div class="form-group" >
                        ...
                        <div class="orderCategoryDD col-md-4" hidden>

                            <select  id="order_category_id" name="order_category_id"  class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-md-4">
                            {{ Form::file('upload_file', ['class' => 'form-control ','required' => 'required','onchange'=>"checkFileExtension(this)"]) }}
                        </div>
...
<script type="text/javascript">
    ...
    function checkFileExtension(element) {
        ...
        if (!allowed_ext.includes(extension)) {
            alert("Sorry! Invalid file. Allowed extensions are: jpeg, png, jpg, doc, docx, 'mp4', 'mov'. ");
            location.reload();
        }
    };
</script>
