...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('training.edit', $training ?? '') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('training.update', $training->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
