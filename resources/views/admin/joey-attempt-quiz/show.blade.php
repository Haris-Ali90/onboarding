...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('joey-attempt-quiz.show', $joeyAttemptQuiz) }}
            ...
            <div class="portlet box blue">
              ...
              {{--          @foreach($details as $key=>$details)
                        <div class="form-group">
                            <!-- Question-->
                                <label class="col-md-2 control-label"><strong>Question:{{$key+1}}</strong> </label>
                                <div class="col-md-2" style="margin-top: 8px;">
                                    <label>{{ $details->question->question }}</label>
                                </div>
                            <!--Answer-->
                                    <label class="col-md-2 control-label"><strong>Answer:{{$key+1}}</strong> </label>
                                    <div class="col-md-2" style="margin-top: 8px;">
                                        <label>{{ $details->answers->answer }}</label>
                                    </div>
                            <!--is coorect-->
                                <label class="col-md-2 control-label"><strong>Correct:</strong> </label>
                                <div class="col-md-2" style="margin-top: 8px;">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <button class="btn black" id="cancel"
                                        onclick="window.location.href = '{!! URL::route('joey-attempt-quiz.index') !!}'">
                                    Back..
                                </button>
                            </div>
                        </div>
