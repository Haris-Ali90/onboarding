@if(can_access_route('joey-attempt-quiz.show',$userPermissoins))
    <a href="{!! URL::route('joey-attempt-quiz.show', $record->id) !!}" title="Detail"
    ...
    @if(isset($record->joey))
        @php
          $joeyId = $record->joey->id;
        @endphp
    @endif

    <a href="{!! URL::route('joey-document-verification.show', $joeyId) !!}" title="Document"
       class="btn btn-xs btn-primary" style="margin-top: 5px;">
        <i >View Document</i>
