...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('customer-send-messages.index') }}
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th style="width: 25%" class="text-center">Message</th>
...
{{--    <script type="text/javascript" src="{!! URL::to('assets/admin/plugins/data-tables/DT_bootstrap.js') !!}"></script>--}}
    ...
    <script>
      ...
      $(function () {
          appConfig.set('yajrabox.ajax', '{{ route('customer-send-messages.data') }}');
          ...
          appConfig.set('yajrabox.columns', [
              ...
              {data: 'message',   orderable: true,   searchable: true , className:'text-center' },
