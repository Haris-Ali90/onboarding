...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joey-checklist.index') }}
    ...
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                        ...
                        <a href="{!! URL::route('joey-checklist.create') !!}" id="sample_editable_1_new" class="btn blue">
        ...
        <div class="row">
            <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                @if(can_access_route('joey-checklist.create',$userPermissoins))
                    <a href="{!! URL::route('joey-checklist.create') !!}" style="background-color: #869636" title="create"
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 40%;min-width: 150px" class="text-center">Joey Checklist</th>
                            <th style="width: 40%;min-width: 70px" class="text-center">Category</th>
                            <th style="width: 15%;min-width: 70px" class="text-center">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('joey-checklist.data') }}');
