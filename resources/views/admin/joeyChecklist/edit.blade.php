...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joey-checklist.edit',$joeyChecklist) }}
 ...
 {{--       @include('admin.partials.errors')--}}
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('joey-checklist.update', $joeyChecklist->id) }}" class="form-horizontal" role="form">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="workType" class="col-md-2 control-label">Title *</label>
                        <div class="col-md-4">
                            <input type="text" id="title" maxlength="190" name="title" value="{{$joeyChecklist->title}}" class="form-control" />
                        </div>
                        @if ($errors->has('title'))
                        ...
                        <div class="col-md-4">
                            <select id="category_id" name="category_id" class="js-example-basic-multiple form-control col-md-7 col-xs-12" >
                                <option  value="" disabled selected>Please select category</option>
                                    ...
                                    <option value="{{$oc->id}}"
                                    @if($oc->id == $joeyChecklist->category_id)
                                            selected="selected"
                                        @endif
