...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('vendor-score.index') }}
            ...
            <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                        ...
                        <a href="{!! URL::route('vendor-score.create') !!}" id="sample_editable_1_new" class="btn blue">
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width:60%" class="text-center">Vendor Name</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('vendor-score.data') }}');
