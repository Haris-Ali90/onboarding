...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('categores.index') }}
            ...
            <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                        ...
                        <a href="{!! URL::route('categores.create') !!}" id="sample_editable_1_new" class="btn blue">
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('categores.data') }}');
