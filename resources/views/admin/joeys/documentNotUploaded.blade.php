...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joeys.documentNotUploaded') }}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                        @if(can_access_route('joeys.bulkDocumentNotUploadedNotification',$userPermissoins))
...
<script>
    var BULK_ACTION_URL = 'bulkDocumentNotUploadedNotification';
</script>
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('joeys.documentNotUploadedData') }}');
...
//for joeys list
    ...
    function Notification(id)
    {
        ...
        if (confirm_val) {
            $.ajax({
                type: "GET",
                url: "documentNotUploadedNotification",
                data: {id: id},
