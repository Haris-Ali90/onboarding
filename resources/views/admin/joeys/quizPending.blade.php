...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joeys.quizPending') }}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                        @if(can_access_route('joeys.bulkQuizPendingNotification',$userPermissoins))
...
<script>
    var BULK_ACTION_URL = 'bulkQuizPendingNotification';
</script>
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('joeys.quizPendingData') }}');
