...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joeys-list.index') }}
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-2">
                        ...
                        <select class="form-control" name="is_enabled">
                            <option value="1"  {{ ($enabled ==  1)?'selected': '' }}>Enable</option>
                            <option value="0"  {{ ($enabled ==  0)?'selected': '' }}>Disable</option>
                        </select>
                    </div>
                    <div class=" col-sm-3">
                        <label>Phone</label>
                    ...
                    <thead>
                        <tr>
                           ...
                           {{-- <th style="width: 5%;min-width: 50px"  class="text-center">ID</th>--}}
                            ...
                            <th style="width: 10%;min-width: 70px"  class="text-center">Agreement</th>
                            <th style="width: 10%;min-width: 70px"  class="text-center">Status</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('joeys.data') }}');
        ...
        appConfig.set('yajrabox.ajax.data', function (data) {
            ...
            data.is_enabled = jQuery('[name=is_enabled]').val();
        });
...
//            {data: 'DT_RowIndex', orderable: false, searchable: false, className:'text-center'},
            ...
            {data: 'document_verification',orderable: false,    searchable: false, className:'text-center'},
            {data: 'training_completion',orderable: false,    searchable: false, className:'text-center'},
            {data: 'quiz_completion',orderable: false,    searchable: false, className:'text-center'},
            {data: 'image',         orderable: false,    searchable: false, className:'text-center'},
            {data: 'Signed At',         orderable: false,    searchable: false, className:'text-center'},
