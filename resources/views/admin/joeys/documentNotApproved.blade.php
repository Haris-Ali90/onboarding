...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('joeys.documentNotApproved') }}
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 10%;min-width: 80px" class="text-center" >Action</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('joeys.documentNotApprovedData') }}');
