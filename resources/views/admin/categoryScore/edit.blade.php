...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('category-score.edit', $categoryScore) }}
 ...
 {{--       @include('admin.partials.errors')--}}
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('category-score.update', $categoryScore->id) }}" class="form-horizontal" role="form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input  type="text"  id="score" maxlength="190" name="score" value="{{ $categoryScore->score }}" class="form-control" />
                        </div>
                        @if ($errors->has('score'))
