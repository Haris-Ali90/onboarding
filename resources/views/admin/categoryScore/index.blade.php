...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('category-score.index') }}
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                       {{-- @if(HasPermissionAccess($userPermissoins['type'],'add',$userPermissoins['permissions']))
                        <a href="{!! URL::route('category-score.create') !!}" id="sample_editable_1_new" class="btn blue">
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width:60%" class="text-center">Category Name</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('category-score.data') }}');
