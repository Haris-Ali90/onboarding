...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('basic-vendor.index') }}
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                       {{-- @if(HasPermissionAccess($userPermissoins['type'],'add',$userPermissoins['permissions']))
                        <a href="{!! URL::route('basic-vendor.create') !!}" id="sample_editable_1_new" class="btn blue">
                ...
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 80%" class="text-center">Vendor</th>
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('basic-vendor.data') }}');
        ...
        appConfig.set('yajrabox.columns', [
            ...
            {data: 'vendor', name : 'vendor.name' ,  orderable: true,   searchable: true, className:'text-center'},
