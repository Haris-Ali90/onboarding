...
<head>
   ...
   {{-- @if (isset($siteSettings->site_logo) && adminHasAssets($siteSettings->site_logo))
    ...
    @else--}}
        <link rel="shortcut icon" href="{!! asset('assets/admin/joeyco_icon.png') !!}" />
   {{-- @endif--}}
   ...
   <!-- socket.io - chat -->
    ...
    <script src="{{ asset('assets/admin/scripts/custom/socket.io.js') }}"></script>
    <script src="{{ asset('assets/admin/scripts/custom/chat.js') }}"></script>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="page-header-fixed">
    ...
    <div class="page-container">
        ...
        <div class="page-sidebar-wrapper">
            ...
            <a href="{!! route('joeys.statistics') !!}">        <img  href="/dashboard"  src="{!! asset('assets/admin/logo.png') !!}" alt="Web Builder" class="img-responsive main-logo" />
