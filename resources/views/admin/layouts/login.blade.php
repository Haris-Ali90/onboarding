...
<head>
    <meta charset="utf-8"/>
    <title>{{--{!! $siteSettings->site_title !!} |--}} Onboarding</title>
...
<body class="login" {{--style="background-size: cover;background-image:url({{ asset('assets/admin/joeyco-theme.jpg') }})"--}}>
    ...
    <!-- BEGIN COPYRIGHT -->
    <div class="copyright">
        {!! \Carbon\Carbon::now()->format('Y') !!} &copy; {!! $siteSettings->site_title !!} Onboarding Portal.
    </div>
    <!-- END COPYRIGHT -->
    ...
    <!-- END JAVASCRIPTS -->
{{--    <img src="{!! asset('assets/admin/under-maintenance.png') !!}" alt="Web Builder" class="img-responsive" style="width:100%; height: 100vh" />--}}
</body>
</html>
