        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                    @if(can_access_route('faqs.create',$userPermissoins))
                        <a href="{!! URL::route('faqs.create') !!}" style="background-color: #e36d29" title="create"
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th style="width: 10%;min-width: 150px" class="text-center">Vendor Name</th>
...
{{--    <script type="text/javascript" src="{!! URL::to('assets/admin/plugins/data-tables/DT_bootstrap.js') !!}"></script>--}}
    ...
    <script>
      ...
      $(function () {
          appConfig.set('yajrabox.ajax', '{{ route('faqs.data') }}');
          ...
          appConfig.set('yajrabox.columns', [
              ...
              {data: 'faq_title',   orderable: true,   searchable: true , className:'text-center' },
              {data: 'faq_description',   orderable: true,   searchable: true , className:'text-center' },
