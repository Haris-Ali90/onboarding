                ...
                <form method="POST"
                    ...
                    @method('PUT')
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="title" maxlength="150" value="{{ old('title',$faq->faq_title) }}"
                                       class="form-control"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="description" maxlength="500" value="{{ old('description',$faq->faq_description) }}"
                                       class="form-control"/>
                            ...
                            <div class="vendorDD col-md-4">
                                ...
                                <select id="vendor_id" name="vendor_id" class="form-control col-md-7 col-xs-12"
                                    ...
                                    @foreach($vendors as $v)
                                        <option value="{{$v->id}}"  <?php echo ($faq->vendor_id == $v->id) ? 'selected' : '';?>>{{$v->name}}</option>
                                    @endforeach
