...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">{{ $pageTitle ?? 'Create New Record' }} <small></small></h3>
        {{ Breadcrumbs::render('system-perameters-settings.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('system-parameters.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
