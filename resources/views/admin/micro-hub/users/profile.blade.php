    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('micro-hub.users.edit-profile') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="phone" maxlength="24" value="{{ old('phone', $data->phone) }}" class="form-control phone_us" />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="file" name="profile_picture" class="form-control" />
                                <br>
{{--                                <img style="border: solid;" src="{!! backendUserUrl($data->profile_picture_auto) !!}" alt="" title="{!! $data->full_name !!}" class="img-responsive" width="150" height="150" /><br>--}}
                            <img style="border: solid;" onClick="preview(this);" src="{{$data->profile_picture}}" alt="" title="{!! $data->full_name !!}" class="img-responsive" width="150" height="150" /><br>
                        </div>
