...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('order-category-list.index') }}
    ...
    <div class="row">
        ...
        <div class="row">
                <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                    @if(can_access_route('order-category-list.create',$userPermissoins))
                        <a href="{!! URL::route('order-category-list.create') !!}" style="background-color: #e36d29" title="create"
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th style="width: 10% ;min-width: 66px;" class="text-center">Order Count</th>
                            <th style="width: 10%" class="text-center">Score</th>

                            <th style="width: 15%;    min-width: 66px;">Created Date</th>
...
{{--    <script type="text/javascript" src="{!! URL::to('assets/admin/plugins/data-tables/DT_bootstrap.js') !!}"></script>--}}
    ...
    <script>
      ...
      $(function () {
          appConfig.set('yajrabox.ajax', '{{ route('order-category-list.data') }}');
