...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('order-category-list.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('order-category-list.store') }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select  id="category_type" name="category_type" class="js-example-basic-multiple form-control col-md-7 col-xs-12" required>
