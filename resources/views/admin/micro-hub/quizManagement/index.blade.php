...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('quiz-management-list.index') }}
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                @if(can_access_route('quiz-management-list.create',$userPermissoins))
                    <a href="{!! URL::route('quiz-management-list.create') !!}" style="background-color: #e36d29" title="create"
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('quiz-management-list.data') }}');
