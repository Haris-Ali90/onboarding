@if(can_access_route('micro-hub.role.show',$userPermissoins))
<a href="{!! URL::route('micro-hub.role.show', $record->id) !!}" title="Detail"
   class="btn btn-xs btn-primary orange">
    <i class="fa fa-eye"></i>
</a>
@endif

@if(can_access_route('micro-hub.role.edit',$userPermissoins))
<a href="{!! URL::route('micro-hub.role.edit', $record->id) !!}" title="Edit"
