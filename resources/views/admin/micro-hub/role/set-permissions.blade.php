...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('micro-hub.role.set-permissions',$role) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST"  action="{{ route('micro-hub.role.set-permissions.update',$role->id) }}" class="form-horizontal"
                        ...
                        <div class="row from-input-wraper">
                            ...
                            <!--from-input-col-open-->
                            <div class="col-md-3 col-sm-4 from-input-col">
                        ...
                        <div class="row from-input-wraper">
                            ...
                            <div class="col-sm-12 text-right from-input-col mt-27">
                                <div class="form-group">
                                    ...
                                    <a href="{{route('micro-hub.role.index')}}"  class="btn orange" id="cancel"> Cancel </a>
                                </div>
                            </div>
                            <!--from-input-col-close-->
                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('#cancel').click(function () {
                window.location.href = "{!! URL::route('micro-hub.role.index') !!}";
            });
        });
    </script>
@stop
