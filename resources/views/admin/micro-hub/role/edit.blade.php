...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('micro-hub.role.edit', $role) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST"  action="{{ route('micro-hub.role.update',$role->id) }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" name="dashboard_card_permission[]" data-placeholder="Please Select Option" multiple="multiple">
