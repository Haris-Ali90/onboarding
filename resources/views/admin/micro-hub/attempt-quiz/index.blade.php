...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('quiz-attempt.index') }}
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th style="width: 10%;min-width: 150px" class="text-center">User Id</th>
                            <th style="width: 25%;min-width: 150px" class="text-center">Name</th>
                            <th style="width: 25%;min-width: 150px" class="text-center">Category Name</th>
                            <th style="width: 25%;min-width: 150px" class="text-center">Passed Yes/No</th>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#cancel').click(function () {
                window.location.href = "{{route('quiz-attempt.index') }}";
            });
        });


        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('quiz-attempt.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'jc_users_id', orderable: true, searchable: true, className: 'text-center'},
                {data: 'micro_hub_user', orderable: true, searchable: true, className: 'text-center'},
