                ...
                <div class="portlet-body">
                    ...
                    <div class="form-horizontal" role="form">
                            ...
                            <label class="col-md-2 control-label"><strong>Role:</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <label class="col-md-2 control-label">
                                        ...
                                        <span class="btn btn-info" style="margin-left: -14px;">{{$sub_admin->Role->display_name}}</span>
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <label class="col-md-2 control-label" style="margin-left: -14px;" >
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <button class="btn black" id="cancel"
                                        onclick="window.location.href = '{!! URL::route('micro-hub.sub-admin.index') !!}'">
                                    Back..
                                </button>
                            </div>
                        </div>
