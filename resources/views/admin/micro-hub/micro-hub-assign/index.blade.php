...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('micro-hub-assign.index') }}
...
{{--    <script type="text/javascript" src="{!! URL::to('assets/admin/plugins/data-tables/DT_bootstrap.js') !!}"></script>--}}
    ...
    <script>
      ...
      $(function () {
          appConfig.set('yajrabox.ajax', '{{ route('micro-hub-assign.data') }}');
          ...
          appConfig.set('yajrabox.columns', [
              ...
              {data: 'userType',         orderable: false,    searchable: false, className:'text-center'},
