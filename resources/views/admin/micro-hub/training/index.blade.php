...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('training-list.index') }}
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                @if(can_access_route('training-list.create',$userPermissoins))
                    <a href="{!! URL::route('training-list.create') !!}" style="background-color: #e36d29" title="create"
...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('micro-hub.training.data') }}');
