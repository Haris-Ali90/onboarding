...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('work-type.index') }}
    ...
    <div class="col-md-12">
                ...
                <div class="table-toolbar pull-right">
                    <div class="btn-group">
                       {{-- @if(HasPermissionAccess($userPermissoins['type'],'add',$userPermissoins['permissions']))
                        <a href="{!! URL::route('work-type.create') !!}" id="sample_editable_1_new" class="btn blue">
        ...
        <div class="row">
            <div class="col-sm-12 mb-5 text-left " style="margin-bottom: 10px">
                @if(can_access_route('work-type.create',$userPermissoins))
                    <a href="{!! URL::route('work-type.create') !!}" style="background-color: #e36d29" title="create"
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th style="width: 80%" class="text-center">Work Type</th>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        $('#cancel').click(function() {
            window.location.href = "{!! URL::route('work-type.index') !!}";
        });
    });
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('work-type.data') }}');
