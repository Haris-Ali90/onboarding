...
// datatable details show li btn function
$(document).on('click','.show-datatable-td-list-btn',function () {
    $(this).closest(".datatable-td-milti-data-show-box-btn-li").siblings('li').toggleClass('hide');
