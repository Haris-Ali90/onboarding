...
{
    const ROLE_TYPE_NAME = 'onboarding';

    const MICRO_HUB_ROLE_TYPE_NAME = 'micro_hub_onboarding';
    ...
    public function scopeNotAdminRole($query)
    {
        ...
        return $query->where('id', '!=' ,$admin_role_id)->where('is_delete',0);
    }
    /**
     * Scope a query to only include micro hub sub admins
     *
     */
    public function scopeMicroHubRole($query)
    {
        return $query->where('type','micro_hub_onboarding');
    }
