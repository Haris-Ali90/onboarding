...
class DocumentNotUploadNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable) : MailMessage
    {
        ...
        $mailMessage = $mailMessage->subject(Email::makeSubject('Document Not Upload'));
        $mailMessage = $mailMessage->line('You do not upload document ,kindly upload your document as soon as possible ');
